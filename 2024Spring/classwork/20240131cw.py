...
class Simulation:
  ...
  def AddCompany(self):
    while True:
      ...
      if CompanyName == "":
        print("Please enter a name for the company that is not empty, please try again.")
        continue
      elif self.GetIndexOfCompany(CompanyName) != -1:
        print("The name you entered is the same as another company, please try again.")
        continue
      else:
        break
