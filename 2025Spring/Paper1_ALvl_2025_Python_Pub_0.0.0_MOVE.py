...
def Main():
    ...
    PlayGame(NumbersAllowed, TrainingGame, MaxTarget, MaxNumber)
    input()
    
def PlayGame(NumbersAllowed, TrainingGame, MaxTarget, MaxNumber):
    global Targets
    Score = 0
    GameOver = False
    while not GameOver:
        ...
        if CheckIfUserInputValid(UserInput):
            ...
            if CheckNumbersUsedAreAllInNumbersAllowed(NumbersAllowed, UserInputInRPN, MaxNumber):
                IsTarget, Score = CheckIfUserInputEvaluationIsATarget(UserInputInRPN, MaxNumber, Score)
                if IsTarget:
...
def CheckIfUserInputEvaluationIsATarget(UserInputInRPN, MaxNumber, Score):
    global Targets
    ...
    if UserInputEvaluation != -1:
        ...
        for i in range(MaxNumber - len(NewTargets)):
